...
export function Header({ status }: HeaderProps) {
  ...
  const isVip = user?.role === UserRole.VIP || user?.vipStatus === 'ACTIVE';
      ...
      <div className="flex items-center justify-between px-6 py-1.5">
        ...
        <div className="flex items-center gap-4">
          ...
          {isAdmin ? (
            ...
            <button
              ...
              className={`
                ...
                bg-gradient-to-r from-yellow-400 to-yellow-500 text-white
                shadow-lg shadow-yellow-500/30
                hover:from-yellow-500 hover:to-yellow-600 hover:shadow-yellow-500/40
                active:scale-[0.98]
                flex items-center gap-1.5
              `}
            >
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-[9999]">
                <div className="px-4 py-2 border-b border-gray-300">
                  <p className="text-xs text-gray-500">Signed in as</p>
                  <div className="flex justify-between item-center">
                    <p className="text-sm item-center font-semibold text-gray-800 truncate">
                      {user?.email}
                    </p>
                    {user?.role && (
                      <span
